...
//  const { t } = useTranslation()
  ...
  return (
    <div className={`${theme} h-dvh overflow-hidden bg-gradient-to-b from-orange-300 to-pink-400 dark:bg-neutral-950 transition-all duration-1000 flex flex-col dark:text-neutral-100 text-neutral-800`}>
