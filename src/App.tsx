...
//  const { t } = useTranslation()
  ...
  return (
    <div className={`${theme} h-dvh overflow-hidden bg-gradient-to-b from-pink-300/90 to-orange-400/90 d-200 dark:bg-neutral-950 transition-all duration-1000 flex flex-col dark:text-neutral-200 text-neutral-700`}>
