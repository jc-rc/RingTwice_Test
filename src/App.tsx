...
//  const { t } = useTranslation()
  ...
  return (
    <div className={`${theme} h-dvh overflow-hidden bg-gradient-to-b from-orange-400/60 to-orange-600/60 d-200 dark:bg-neutral-900 transition-all duration-1000 flex flex-col dark:text-neutral-200 text-neutral-700`}>
