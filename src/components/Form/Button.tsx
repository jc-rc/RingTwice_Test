...
function Button(props: ButtonProps = {
    ...
    return (
        <button
            ...
            className={`flex items-center justify-center gap-2 rounded-xl px-4 py-2 hover:brightness-90 disabled:opacity-50 disabled:cursor-not-allowed clickable select-none ${props.className}`}
        >
